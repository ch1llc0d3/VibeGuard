# VibeGuard Security Infrastructure
...
3. **CloudOps** - Cloud infrastructure security management
4. **AppSec** - Application security monitoring and hardening
5. **InfraOps** - Infrastructure protection and monitoring
...
### Step 3: Inject the Gemini/OpenRouter Keys
